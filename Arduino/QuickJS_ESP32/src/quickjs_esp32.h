...
//              js_module_set_import_meta(ctx, val, TRUE, TRUE);
  ...
  void add_modules(JSValue global){
    addModule_esp32(ctx, global);
    addModule_wire(ctx, global);
    addModule_wire1(ctx, global);
    addModule_input(ctx, global);
    addModule_http(ctx, global);
    addModule_ledc(ctx, global);
    addModule_pixels(ctx, global);
    addModule_utils(ctx, global);
#ifdef _LOGIO_ENABLE_
    addModule_console(ctx, global);
#endif
#ifdef _RTC_ENABLE_
    addModule_rtc(ctx, global);
#endif
    addModule_gpio(ctx, global);
#ifdef _IMU_ENABLE_
    addModule_imu(ctx, global);
#endif
#ifdef _LCD_ENABLE_
    addModule_lcd(ctx, global);
#endif
#ifdef _MQTT_ENABLE_
    addModule_mqtt(ctx, global);
#endif
#ifdef _SD_ENABLE_
    addModule_sd(ctx, global);
#endif
  }
